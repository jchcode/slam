...
if tor_i > 0
    ...
    C_new_old = old_C_b_n' * (eye(3) - (Skew_symmetric(omega_ie_n) + ...
        0.5 * Skew_symmetric(old_omega_en_n) + 0.5 *...
        Skew_symmetric(omega_en_n)) * tor_i)' * C_b_n;
    ...
    temp = acos(0.5 * (trace(C_new_old) - 1));

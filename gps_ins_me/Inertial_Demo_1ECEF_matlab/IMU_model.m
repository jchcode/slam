...
if IMU_errors.accel_quant_level>0
    meas_f_ib_b = IMU_errors.accel_quant_level * round((uq_f_ib_b +...
        old_quant_residuals(4:6)) / IMU_errors.accel_quant_level);
    quant_residuals(4:6,1) = uq_f_ib_b + old_quant_residuals(4:6) -...
        meas_f_ib_b;
else
...
if IMU_errors.gyro_quant_level>0
    meas_omega_ib_b = IMU_errors.gyro_quant_level * round((uq_omega_ib_b +...
        old_quant_residuals(1:3)) / IMU_errors.gyro_quant_level);
    quant_residuals(1:3,1) = uq_omega_ib_b + old_quant_residuals(1:3) -...
        meas_omega_ib_b;
else
